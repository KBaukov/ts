...
var resize = function(e) {
	...
	if(w>=1340) {
		$("div#confBox")[0].style.float = 'right';
		$("div#offerBox")[0].style.float = 'right';
		$("div#addrBox")[0].style.width = '25%';
		$("div#addrBox")[0].style.paddingLeft = '30px';
	}
	if(w<1340 && w>=1110) {
		$("div#addrBox")[0].style.width = '35%';
		$("div#addrBox")[0].style.paddingLeft = '30px';
		$("div#confBox")[0].style.float = 'left';
		$("div#offerBox")[0].style.float = 'right';
		$("div#offerBox")[0].style.paddingRight = '10px';
	}
	if(w<1110 && w>=800) {
		$("div#offerBox")[0].style.float = 'left';
		$("div#offerBox")[0].style.paddingRight = '35px';

	}
	if(w<800) {

		//$("div#zalContainer")[0].style.overflowX = 'scrol';
	}
